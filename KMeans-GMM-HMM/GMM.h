...
private:
	int m_dimNum;		// the dim of the feature
	int m_mixNum;		// Gaussian component number
	double* m_priors;	// Gaussian weight
	double** m_means;	// Gaussian means
	double** m_vars;	// Gaussian variances (only diagonal GMM supported )
